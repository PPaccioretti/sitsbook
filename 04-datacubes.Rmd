...
if (!file.exists("./tempdir/chp4"))
  dir.create("./tempdir/chp4")
if (!file.exists("./tempdir/chp4/s2_19HBA"))
  dir.create("./tempdir/chp4/s2_19HBA")
if (!file.exists("./tempdir/chp4/dem_19HBA"))
  dir.create("./tempdir/chp4/dem_19HBA")
```
...
```{r mgrs, echo = FALSE, out.width="80%", fig.align="center", fig.cap="MGRS tiling system used by Sentinel-2 images (source: US Army. Reproduction based on fair use doctrine)."}
...
```{r aws, echo = FALSE, out.width="100%", fig.align="center", fig.cap= "Sentinel-2 image in an area of the Northeastern coast of Brazil (&copy; EU Copernicus Sentinel Programme; source: AWS)."}
...
```{r mpc1, echo = FALSE, out.width="100%", fig.align="center", fig.cap= "Sentinel-2 image in an area of the state of Rondonia, Brazil (&copy; EU Copernicus Sentinel Programme; source: Microsoft)."}
...
```{r mpc2, echo = FALSE, out.width="100%", fig.align="center", fig.cap= "Landsat-8 image in an area in Northeast Brazil (sources: USGS and Microsoft)."}
...
```{r mpc3, tidy="styler", echo = FALSE, out.width="100%", fig.align="center", fig.cap= "Sentinel-1 image in an area in Mato Grosso, Brazil (&copy; EU Copernicus Sentinel Programme; source: Microsoft)."}
...
```{r mpcrtcol, tidy="styler", eval = TRUE, echo = FALSE, out.width="100%", fig.align="center", fig.cap= "Sentinel-1-RTC image of an area in Colombia (&copy; EU Copernicus Sentinel Programme; source: Microsoft)."}
...
```{r mpc4, tidy="styler", echo = FALSE, eval = TRUE, out.width="100%", fig.align="center", fig.cap= "Copernicus 30-meter DEM of an area in Brazil (&copy; DLR e.V. 2010-2014 and &copy Airbus Defence and Space GmbH 2014-2018 provided under COPERNICUS by the European Union and ESA; source: Microsoft)."}
...
```{r bdc, echo = FALSE, out.width="80%", fig.align="center", fig.cap="Hierarchical BDC tiling system showing (a) large BDC grid overlayed on Brazilian biomes, (b) one large tile, (c) four medium tiles, and (d) sixteen small tiles (Source: Ferreira et al. (2020). Reproduction under fair use doctrine)."}
...
```{r cbers, echo = FALSE, out.width="100%", fig.align="center", fig.cap="CBERS-4 WFI image in a Cerrado area in Brazil (&copy; INPE/Brazil licensed under CC-BY-SA. source: Brazil Data Cube)."}
...
```{r lena, echo = FALSE, out.width="100%", fig.align="center", fig.cap= "Sentinel-2 image of the Lena river delta in summertime (&copy; EU Copernicus Sentinel Programme; source: CDSE)."}
...
```{r cdsertc, echo = FALSE, out.width="100%", fig.align="center", fig.cap= "Sentinel-1-RTC image of the Rift Valley in Ethiopia (&copy; EU Copernicus Sentinel Programme; source: CDSE)."}
...
```{r dea1, echo = FALSE, out.width="100%", fig.align="center", fig.cap="Sentinel-2 image in an area over Madagascar (&copy; EU Copernicus Sentinel Programme; source: Digital Earth Africa)."}
...
```{r seren, echo = FALSE, out.width="100%", fig.align="center", fig.cap="Landsat-9 image in an area over the Serengeti in Tanzania (source: Digital Earth Africa)."}
...
```{r lakekivu, echo = FALSE, out.width="100%", fig.align="center", fig.cap="ALOS-PALSAC mosaic in the Congo forest area (&copy; JAXA EORC; source: Digital Earth Africa)."}
...
```{r goldcoast, echo = FALSE, eval = TRUE, out.width="100%", fig.align="center", fig.cap="Plot of Sentinel-2 image obtained from the DEAUSTRALIA collection for date 2023-10-14 showing MGRS tile 56KKV (&copy; EU Copernicus Sentinel Programme; source: Digital Earth Australia)."}
...
```{r hlssen, echo = FALSE, eval = TRUE, out.width="100%", fig.align="center", fig.cap="Plot of Sentinel-2 image obtained from the NASA HLS collection for date 2020-06-15 showing the island of Ilhabela in the Brazilian coast  (&copy;EU Copernicus Sentinel Programme; source: NASA)."}
...
```{r worldcover, echo = FALSE, eval = TRUE, out.width="100%", fig.align="center", fig.cap="Plot of World Cover 2021 map covering MGRS tile 22LBL (&copy; TerraScope)."}
